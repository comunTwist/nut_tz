 ...
 * @see WP_Widget
 */
class custom_html extends WP_Widget {
	...
	public function __construct() {
        $widget_ops  = array(
            'classname'                   => 'user_custom_html',
            'description'                 => 'Пользовательский HTML-код',
        ...
        parent::__construct( 'user_custom_html', __( 'Custom HTML' ), $widget_ops, $control_ops );
	}
